...
#define BOARD_LCD_DC_GPIO_PIN 14U   /*! LCD data/command pin */
#define BOARD_LCD_CS_GPIO     GPIO1 /*! LCD chip select port (was LPSPI1_PCS0) */
#define BOARD_LCD_CS_GPIO_PIN 11U   /*! LCD chip select pin  (GPIO_AD_B0_11)  */
