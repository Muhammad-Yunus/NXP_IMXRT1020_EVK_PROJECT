...
/* GPIO_AD_B0_14 (number 94), LCD_DC/U11[24]/J17[7] */
/* Routed pin properties */
#define BOARD_INITPINS_LCD_DC_PERIPHERAL                                   GPIO1   /*!< Peripheral name */
#define BOARD_INITPINS_LCD_DC_SIGNAL                                     gpio_io   /*!< Signal name */
#define BOARD_INITPINS_LCD_DC_CHANNEL                                        14U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_LCD_DC_GPIO                                         GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_LCD_DC_GPIO_PIN                                       14U   /*!< GPIO pin number */
#define BOARD_INITPINS_LCD_DC_GPIO_PIN_MASK                          (1U << 14U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_LCD_DC_PORT                                         GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_LCD_DC_PIN                                            14U   /*!< PORT pin number */
#define BOARD_INITPINS_LCD_DC_PIN_MASK                               (1U << 14U)   /*!< PORT pin mask */

/* GPIO_AD_B1_10 (number 80), LCD_TOUCH_YM_ADC_A0/J18[1] */
/* Routed pin properties */
#define BOARD_INITPINS_LCD_TOUCH_YM_ADC_A0_PERIPHERAL                       ADC1   /*!< Peripheral name */
#define BOARD_INITPINS_LCD_TOUCH_YM_ADC_A0_SIGNAL                             IN   /*!< Signal name */
#define BOARD_INITPINS_LCD_TOUCH_YM_ADC_A0_CHANNEL                           10U   /*!< Signal channel */

/* GPIO_AD_B1_11 (number 79), LCD_TOUCH_XM_ADC_A1/J18[2] */
/* Routed pin properties */
#define BOARD_INITPINS_LCD_TOUCH_XM_ADC_A1_PERIPHERAL                       ADC1   /*!< Peripheral name */
#define BOARD_INITPINS_LCD_TOUCH_XM_ADC_A1_SIGNAL                             IN   /*!< Signal name */
#define BOARD_INITPINS_LCD_TOUCH_XM_ADC_A1_CHANNEL                           11U   /*!< Signal channel */

/* GPIO_AD_B1_12 (number 78), LCD_TOUCH_YP_ADC_A2/J18[3] */
/* Routed pin properties */
#define BOARD_INITPINS_LCD_TOUCH_YP_ADC_A2_PERIPHERAL                       ADC1   /*!< Peripheral name */
#define BOARD_INITPINS_LCD_TOUCH_YP_ADC_A2_SIGNAL                             IN   /*!< Signal name */
#define BOARD_INITPINS_LCD_TOUCH_YP_ADC_A2_CHANNEL                           12U   /*!< Signal channel */

/* GPIO_AD_B1_13 (number 76), LCD_TOUCH_XP_ADC_A3/J18[4] */
/* Routed pin properties */
#define BOARD_INITPINS_LCD_TOUCH_XP_ADC_A3_PERIPHERAL                       ADC1   /*!< Peripheral name */
#define BOARD_INITPINS_LCD_TOUCH_XP_ADC_A3_SIGNAL                             IN   /*!< Signal name */
#define BOARD_INITPINS_LCD_TOUCH_XP_ADC_A3_CHANNEL                           13U   /*!< Signal channel */
